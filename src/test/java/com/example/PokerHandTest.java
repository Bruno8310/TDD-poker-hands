...
public class PokerHandTest {
    ...
    void should_return_winner_is_player2_when_compare_high_card_given_player1_2H3D5S9CKD_and_player2_2C3H4S8CAH() {
        ...
        String result = pokerHandService.pokerHand(playerOnePokers, playerTwoPokers);
    ...
    void should_return_winner_is_player2_when_compare_pair_card_given_player1_2H3D5S9CKD_and_player2_3H3D5S9CKD() {
        ...
        // when
        PokerHandService pokerHandService = new PokerHandService();
        String result = pokerHandService.pokerHandPair(playerOnePokers, playerTwoPokers);
    ...
    @Test
    void should_return_winner_is_player1_when_compare_pair_card_given_player1_3H3D5S9CKD_and_player2_2H3D5S9CKD() {
        // given
        List<Poker> playerOnePokers = Arrays.asList(
                new Poker("3", 'H'),
                new Poker("3", 'D'),
    ...
    @Test
    void should_return_winner_is_player1_when_compare_pair_card_given_player1_3H3D5S9CKD_and_player2_2H2D5S9CKD() {
        // given
        List<Poker> playerOnePokers = Arrays.asList(
                new Poker("3", 'H'),
                new Poker("3", 'D'),
    ...
    @Test
    void should_return_winner_is_player2_when_compare_pair_card_given_player1_3H3D5S9CKD_and_player2_2H2D5S5CKD() {
        // given
        List<Poker> playerOnePokers = Arrays.asList(
                new Poker("3", 'H'),
                new Poker("3", 'D'),
